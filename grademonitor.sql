...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2018 at 05:31 AM
...
INSERT INTO `student` (`student_ID`, `name`, `username`, `password`, `parent_ID`) VALUES
(1, 'David Libetario Jr', 'student1', 'student1', 1),
(2, 'Edgar Libetario', 'student2', 'student2', 1),
(3, 'Seralyn Lim', 'student3', 'student3', 2),
(4, 'Leah Lim', 'student4', 'student4', 3),
(5, 'Sarah Limbo', 'student5', 'student5', 4),
(6, 'Edie Limpag', 'student6', 'student6', 5),
(7, 'Arthur Llanera', 'student7', 'student7', 6),
(8, 'Dave Loma', 'student8', 'student8', 7),
(9, 'Erikka Loma', 'student9', 'student9', 7),
(10, 'Alan Lomod', 'student10', 'student10', 8),
(11, 'Angela Lood', 'student11', 'student11', 9),
(12, 'Ian Vester Lubaton', 'student12', 'student12', 10),
(13, 'Belen Lura', 'student13', 'student13', 11),
(14, 'Roy Lumayosa', 'student14', 'student14', 12),
(15, 'Joshua Lusica', 'student15', 'student15', 13),
(16, 'Nathan Mabao', 'student16', 'student16', 14),
(17, 'Cecille Macaraya', 'student17', 'student17', 15);
...
CREATE TABLE `student_section` (
  `student_section_ID` int(10) NOT NULL,
  `student_ID` int(10) NOT NULL,
  `section_ID` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `student_section` (`student_section_ID`, `student_ID`, `section_ID`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 2),
(4, 4, 2),
...
ALTER TABLE `student_section`
  ...
  ADD KEY `fk_studentsection` (`student_ID`);
...
--
ALTER TABLE `student_section`
  MODIFY `student_section_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
...
ALTER TABLE `student_section`
  ...
  ADD CONSTRAINT `fk_studentsection` FOREIGN KEY (`student_ID`) REFERENCES `student` (`student_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
